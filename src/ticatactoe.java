...
class ticatactoe {
   ...
   private static final int ROWS = 3;
    private static final int COLS = 3; // number of rows and columns
   private static final int[][] board = new int[ROWS][COLS]; // game board in 2D array
   ...
   private static int currntRow;
    private static int currentCol; // current seed's row and column
 
   private static final Scanner in = new Scanner(System.in); // the input Scanner
